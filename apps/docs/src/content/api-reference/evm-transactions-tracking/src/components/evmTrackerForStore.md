...
# Function: evmTrackerForStore()

> **evmTrackerForStore**\<`T`\>(`__namedParameters`): `Promise`\<`void`\>

Defined in: [packages/evm-transactions-tracking/src/trackers/evmTracker.ts:134](https://github.com/TuwaIO/web3-transactions-tracking/blob/main/packages/evm-transactions-tracking/src/trackers/evmTracker.ts#L134)
