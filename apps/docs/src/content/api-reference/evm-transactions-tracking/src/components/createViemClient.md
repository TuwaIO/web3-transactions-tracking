...
Defined in: [packages/evm-transactions-tracking/src/utils/createViemClient.ts:16](https://github.com/TuwaIO/web3-transactions-tracking/blob/main/packages/evm-transactions-tracking/src/utils/createViemClient.ts#L16)
