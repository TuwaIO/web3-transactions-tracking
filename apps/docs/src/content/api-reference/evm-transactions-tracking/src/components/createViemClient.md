...
Defined in: [packages/evm-transactions-tracking/src/utils/createViemClient.ts:16](https://github.com/TuwaIO/web3-transactions-tracking/blob/d33a798a7b6f5ea37a9cf7f32c6601e6ce651d45/packages/evm-transactions-tracking/src/utils/createViemClient.ts#L16)
...
A viem PublicClient instance if the chain is found in the provided array, otherwise undefined.
