...
import { TxActionButton } from '@tuwa/transactions-tracking-ui/dist';
...
export const TransactionsBlock = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md h-auto min-h-[680px] bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 flex-shrink-0">
          <div className="flex justify-between items-center gap-2 flex-wrap">
            <div className="flex-1 pr-4">
              <h1 className="text-2xl font-bold text-white mb-1 leading-tight">TUWA Demo</h1>
        ...
        <div className="flex-1 p-8 space-y-8">
          <div className="text-center h-16 flex flex-col justify-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-tight">
          ...
          <div className="space-y-6 flex-1">
            <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-4 border border-slate-200 dark:border-slate-600 min-h-[100px] flex flex-col justify-center">
              <div className="flex items-center justify-between w-full mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-medium text-slate-900 dark:text-slate-100 leading-tight">Counter Contract</h3>
                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-tight">Sepolia Testnet</p>
                  </div>
                </div>
                <div className="text-right flex-shrink-0">
                  <div className="text-sm text-slate-600 dark:text-slate-400 leading-tight">Contract</div>
                  <button
                    onClick={openEtherscan}
                    className="text-xs font-mono text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 leading-tight cursor-pointer transition-colors duration-200 underline hover:no-underline"
                  >
              ...
              <div className="flex items-center justify-center pt-2 border-t border-slate-200 dark:border-slate-600">
            ...
            <div className="space-y-4">
              ...
              <div className="h-8 flex items-center justify-center">
                <p className="text-center text-xs text-slate-500 dark:text-slate-400 leading-tight">
        ...
        <div className="bg-slate-50 dark:bg-slate-700 px-8 py-4 border-t border-slate-200 dark:border-slate-600 flex-shrink-0 h-16 flex items-center justify-center">
          <div className="flex items-center space-x-2 text-xs text-slate-500 dark:text-slate-400">
            <span className="leading-none">Powered by</span>
            <span className="font-semibold text-blue-600 dark:text-blue-400 leading-none">TUWA</span>
