# TUWA Web3 Transaction Tracking Suite + Next.js + Dynamic Example

A minimal example demonstrating how to integrate the **TUWA Web3 Transaction Tracking Suite** into a Next.js application using App Directory and Dynamic.xyz.
...
- [Dynamic Docs](https://www.dynamic.xyz/docs/introduction/welcome)
